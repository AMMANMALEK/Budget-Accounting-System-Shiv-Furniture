 ...
 * 
 * This service manages purchase bill operations including creation, validation,
 * updating, posting, and status management. Purchase bills follow the same
 * draft/posted workflow as invoices to ensure financial data integrity.
 * 
 * Key Features:
 * - Purchase bill creation with automatic draft status
 * - Comprehensive validation for required fields
 * - Status-based modification restrictions
 * - Purchase bill posting workflow (draft → posted)
 * - Status validation utilities
 * - Posting eligibility checks
 * 
 * Business Rules:
 * - New purchase bills are created with 'draft' status
 * - Only draft purchase bills can be modified or deleted
 * - Posted purchase bills are immutable
 * - Amount must be greater than 0
 * - Description is required and cannot be empty
 * - Cost center ID is required
 * 
 * This service ensures proper financial controls while providing flexibility
 * during the data entry and review process.
 */
