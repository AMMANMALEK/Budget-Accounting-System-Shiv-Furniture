 ...
 * 
 * This service provides intelligent automatic categorization of transactions
 * based on predefined analytical models. It helps reduce manual data entry
 * by automatically assigning cost centers to transactions based on patterns.
 * 
 * Key Features:
 * - Automatic transaction categorization when posted
 * - Pattern matching based on partners, products, and tags
 * - Model specificity scoring and best match selection
 * - Analytics suggestions for UI preview
 * - Bulk analytics application
 * - Coverage analysis and reporting
 * - Model validation and state management
 * 
 * Matching Criteria:
 * - partner_id: Specific customer or supplier
 * - partner_tag_id: Partner category or classification
 * - product_id: Specific product
 * - product_category_id: Product category
 * 
 * Model States:
 * - draft: Model is being configured
 * - confirmed: Model is active and will be applied
 * - cancelled: Model is inactive
 * 
 * This service significantly reduces manual work by learning from historical
 * transaction patterns and automatically applying appropriate cost center
 * assignments to new transactions.
 */
